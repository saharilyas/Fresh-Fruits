...
const MenusData = [
  { id:1, title:"Fresh Red Apple", link:"/", price:"3.00 $", img: Fruit1, delay: 0.3 },
  { id:2, title:"Fresh Oranges", link:"/", price:"2.00 $", img: Fruit2, delay: 0.6 },
  { id:3, title:"Fresh Avocado", link:"/", price:"4.00 $", img: Fruit3, delay: 0.9 },
  { id:4, title:"Fresh Cherries", link:"/", price:"5.00 $", img: Fruit4, delay: 1.2 },
];
      ...
      <div className="container pt-12 pb-20">
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6'>
          {MenusData.map((menu) => (
            ...
            >
              <img src={menu.img} alt={menu.title} className='w-[60px] mb-4 scale-110 transform -translate-y-1' />
              <div>
